...
import { type NutritionProfile, type Recipe, type RecipeGenerationRequest } from '@/types/recipe';
import { AlertCircle, ArrowLeft, RefreshCw } from 'lucide-react';
import { useRouter } from 'next/navigation';
import { useCallback, useEffect, useState } from 'react';

type GenerationStage = 'initializing' | 'generating' | 'validating' | 'complete';
...
export default function RecipeGeneratePage() {
  ...
  const [generationStage, setGenerationStage] = useState<GenerationStage>('initializing');
  const [generatedRecipe, setGeneratedRecipe] = useState<Recipe | null>(null);
  const [error, setError] = useState<string | null>(null);
  const [lastRequest, setLastRequest] = useState<RecipeGenerationRequest | null>(null);
  ...
  const simulateGenerationStages = useCallback(async () => {
    const stages: GenerationStage[] = ['initializing', 'generating', 'validating', 'complete'];
