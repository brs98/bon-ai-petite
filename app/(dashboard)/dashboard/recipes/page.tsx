...
import { BookOpen, ChefHat, Clock, Plus, TrendingUp } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Generate personalized recipes, save your favorites, and plan your meals
              </p>
            </div>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer">
            <Link href="/dashboard/recipes/generate">
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  Create AI-powered recipes tailored to your nutrition goals and preferences
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">Generate your first recipe to get started!</p>
                </div>
              </div>
            </CardContent>
          </Card>
