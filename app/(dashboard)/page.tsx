                      ...
                      {[
                        {
                          ...
                          image: "https://images.unsplash.com/photo-1525351484163-7529414344d8?w=400&h=400&fit=crop&crop=center",
                        ...
                        >
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-muted-foreground text-sm">{item.dish}</p>
                          </div>
                        </motion.div>
                      ))}
                    </motion.div>
            ...
            {[
              {
                ...
                description: "Our advanced AI analyzes your dietary preferences, health goals, and lifestyle to create perfectly tailored meal plans that evolve with you."
              },
              {
                icon: ShoppingCart,
                gradient: "from-accent to-blue-500",
                title: "Seamless Shopping Integration",
                description: "One-click integration with Instacart and Amazon Fresh. Your ingredients are automatically added to your cart and delivered to your door."
              },
              {
                icon: Clock,
                gradient: "from-emerald-400 to-emerald-600",
                title: "Save Time & Reduce Waste",
                description: "Spend less time planning and shopping, more time enjoying delicious meals. Our smart portions reduce food waste by up to 40%."
              }
            ].map((feature, index) => (
              <motion.div 
                key={index}
                ...
                {[
                  {
                    ...
                    description: "Achieve your wellness goals with nutritionally balanced meals designed by experts."
                  },
                  {
                    icon: Clock,
                    ...
                    description: "Reclaim hours each week with automated meal planning and grocery shopping."
                  },
                  {
                    icon: Users,
                    ...
                    description: "Create meal plans that satisfy everyone's tastes and dietary requirements."
                  }
                ].map((benefit, index) => (
                  <motion.div 
                    key={index}
                ...
                {[
                  {
                    gradient: "from-emerald-50 to-emerald-100/50",
                    border: "border-emerald-200/50",
                    quote: "AI Petite has completely transformed how my family eats. We're healthier, happier, and I save 5 hours every week!",
                    name: "Sarah M.",
                    role: "Busy Mom of 3",
                    avatar: "SM",
                  ...
                  },
                  {
                    gradient: "from-blue-50 to-blue-100/50",
                    border: "border-blue-200/50",
                    quote: "The AI recommendations are spot-on. I've discovered so many new healthy recipes that I actually enjoy cooking!",
                    name: "Michael J.",
